...
Rules:
- TRANSCRIBE VERBATIM: write down EXACTLY what was said in the audio, including grammar mistakes and hesitations. Do not silently fix errors in the transcript. Put fixes in "corrected_ko" and "issues".
- If the audio is silent or unintelligible: "transcript_ko" must be an empty string, "issues" an empty array, "score" 0, and explain in "fluency_note_en". NEVER invent speech. (score is 0 ONLY in that case; otherwise 1-5.)
...
- "more_natural_ko": a natural way to say the same thing.
...
{
  "transcript_ko": "verbatim transcript",
  "corrected_ko": "transcript with mistakes corrected",
  "score": 0-5 (integer; 0 ONLY if silent/unintelligible),
  "issues": [
    {"original": "fragment", "fix": "fix", "type": "grammar|particle|conjugation|word_choice|unnatural|pronunciation|other", "explanation_en": "English explanation"}
  ],
  "more_natural_ko": "a more natural Korean version",
  "pronunciation_notes": [
    {"word": "word", "note_en": "note", "confidence": "low|medium|high"}
  ],
  "fluency_note_en": "short fluency note in English",
